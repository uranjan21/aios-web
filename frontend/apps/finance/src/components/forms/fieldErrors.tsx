 ...
 *
 * Before this, every finance form reported failure with a toast — "Failed to
 * create account" — which says THAT something went wrong and never WHICH
 ...
 * `FieldError` supplies one. Kept in `apps/finance` deliberately — `packages/`
 * is owned elsewhere. `apps/health` carries its own copy; promote both into
