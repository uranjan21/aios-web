...
| 6 | **Resolve Follow-up UI/UX Issues (R1-R4)** | Implement unified toolbar & pinned actions, strict card/table wrapper usage, sidebar contrast fix, and TopBar breadcrumbs + spacing. | Milestone 5 | IN_PROGRESS |
