...
Also merges the two open heads (u002_failed_webhooks + p001_finance_composite_indexes)
into a single linear head so `alembic upgrade head` works again.
...
# Merge both open heads into one.
down_revision: Union[str, Sequence[str], None] = (
    "u002_failed_webhooks",
    "p001_finance_composite_indexes",
)
