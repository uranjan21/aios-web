...
- Verified: backend **163 passing** on host (incl. `test_api_mappings` guarding `/api/chat/models`), `tsc --noEmit` + `pnpm build` clean, 2-worker leader test, ChatPage + rail + quota walked in preview with zero console errors.
